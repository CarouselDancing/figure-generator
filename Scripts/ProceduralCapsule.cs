...
public struct BoundaryPoints
{
    ...
    public Vector3 point1, point2, point3, point4, point5, point6;
}
...
public class ProceduralCapsule : MonoBehaviour
{
    ...
    public BoundaryPoints boundaryPoints;
    ...
    {
        CreateMeshWithOffset(Vector3.zero, Quaternion.identity);
    }

    public void CreateMeshWithOffset(Vector3 offset, Quaternion q)
    {
        ...
        boundaryPoints.point1 = q * (offset + new Vector3(radius / 2, 0f, 0f));
        boundaryPoints.point2 = q * (offset + new Vector3(-radius / 2, 0f, 0f));
        boundaryPoints.point3 = q * (offset + new Vector3(0f, height/2, 0f));
        boundaryPoints.point4 = q * (offset + new Vector3(0f, -height / 2, 0f));
        boundaryPoints.point5 = q * (offset + new Vector3(0f, 0f, radius));
        boundaryPoints.point6 = q * (offset + new Vector3(0f, 0f, -radius));
    }
}